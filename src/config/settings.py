...
from .models import ContextAIConfig, ActiveEmbeddings, EmbeddingInfo, AIProviderConfig
...
class SettingsManager:
    ...
    def _load_active(self) -> None:
        ...
        try:
            ...
            self.logger.warning("Failed to load active embeddings, using defaults: %s", e)
            self._active = ActiveEmbeddings()
