...
class GuidelinesManager:
    ...
    def _load_guidelines(self) -> None:
        ...
        try:
            ...
            self.logger.debug("Loaded guidelines for languages: %s", 
    ...
    def get_guidelines_for_languages(self, languages: List[str]) -> Optional[str]:
        ...
        if len(applicable_guidelines) == 1:
            ...
            combined = f"## 📋 Coding Guidelines for Multiple Languages\n\n"
    ...
    def should_apply_guidelines(self, context: str, question: str) -> bool:
        ...
        code_keywords = [
            'implement', 'code', 'function', 'class', 'component', 'method',
            'refactor', 'optimize', 'create', 'build', 'develop', 'write',
            'how to', 'example', 'pattern', 'architecture', 'design'
        ]
    ...
    def get_applicable_guidelines(self, context: str, question: str) -> Optional[str]:
        ...
        if guidelines:
            self.logger.debug("Applying guidelines for languages: %s", ', '.join(languages))
